...
DB_HOST_PORT="${DB_HOST_PORT:-${POSTGRESQL_PORT:-5432}}"
DB_NAME="${DB_NAME:-zulip}"
DB_SCHEMA="${DB_SCHEMA:-zulip}"
DB_USER="${DB_USER:-${POSTGRESQL_USER:-zulip}}"
DB_PASSWORD="${DB_PASSWORD:-${POSTGRESQL_PASS:-zulip}}"
...
RABBITMQ_USERNAME="${RABBITMQ_USERNAME:-${RABBITMQ_USER:-zulip}}"
RABBITMQ_PASSWORD="${RABBITMQ_PASSWORD:-${RABBITMQ_PASS:-zulip}}"
RABBITMQ_PASS="${RABBITMQ_PASS:-$(echo $RABBITMQ_PASS)}"
...
MEMCACHED_HOST_PORT="${MEMCACHED_HOST_PORT:-${MEMCACHED_PORT:-11211}}"
